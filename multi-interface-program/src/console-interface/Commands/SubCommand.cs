    ...
    public class SubCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
		{
			return Task.Run(() => {
				...
				if (a != null && b != null)
				{
					int c = SharedClass.sub(a.Value, b.Value);
					Console.WriteLine(c);
				}
				else
				{
		...
		public void printHelp()
		{
			StringBuilder helpTextBuilder = new StringBuilder();
           	...
           	helpTextBuilder.AppendLine("Usage:  Console-Interface sub [OPTION] <int> <int> ");
