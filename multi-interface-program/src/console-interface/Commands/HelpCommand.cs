    ...
    public class HelpCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
		{
			return Task.Run(() => {
            	...
            	helpTextBuilder.AppendLine("Usage:  Console Interface [OPTION]  ");
				helpTextBuilder.AppendLine("");
				helpTextBuilder.AppendLine("    add");
				helpTextBuilder.AppendLine("    sub");
				helpTextBuilder.AppendLine("    mul");
				helpTextBuilder.AppendLine("    div");
            	helpTextBuilder.AppendLine("");
