    ...
    public class MulCommand : ICommand
    {
        ...
        public Task<bool> ExecuteAsync()
		{
			return Task.Run(() => {
				...
				if (a != null && b != null)
				{
					int c = SharedClass.mul(a.Value, b.Value);
					Console.WriteLine(c);
				}
				else
				{
		...
		public void printHelp()
		{
			StringBuilder helpTextBuilder = new StringBuilder();
           	...
           	helpTextBuilder.AppendLine("Usage:  Console-Interface mul [OPTION] <int> <int> ");
